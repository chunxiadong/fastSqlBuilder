package com.qiushangcheng.fastsqlbuilder.demo.repository.secondary;
 ...
 */
@Repository
public class Demo2Repository extends SqlExecutor {
    @Resource(name = "secondaryNamedParameterJdbcTemplate")
...
//        // 简单查询
        SqlBuildResult select1 = sqlBuilder.select().where().equal(Demo1Path.id, 34).build();
